...
var DataManager = /*#__PURE__*/function () {
  function DataManager() {
    ...
    (0, _defineProperty2["default"])(this, "lazyParentFunc", null);
  ...
  (0, _createClass2["default"])(DataManager, [{
    ...
    key: "changeLazyParent",
    value: function changeLazyParent(lazyParentFunc) {
    ...
    value: function treefyData() {
      ...
      var addRow = function addRow(rowData) {
        rowData.isLazyParent = _this6.lazyParentFunc && _this6.lazyParentFunc(rowData);
